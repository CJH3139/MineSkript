...
import com.mineskript.client.player.elements.CondHasPotion;
import com.mineskript.client.player.elements.CondIsPoisoned;
...
import com.mineskript.client.player.elements.ExprPotionEffectTier;
import com.mineskript.client.player.elements.ExprRemainingAir;
...
public final class PlayerModule implements SyntaxModule {
    ...
    public void register(SyntaxRegistry registry) {
        ...
        ExprRemainingAir.register(registry);
        ...
        ExprPotionEffectTier.register(registry);
