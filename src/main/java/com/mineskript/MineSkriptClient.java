...
public final class MineSkriptClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EventDispatcher dispatcher = new EventDispatcher(registry, bridge, new Interpreter(STEP_BUDGET), new Scheduler());
        ...
        ClientLifecycleEvents.CLIENT_STARTED.register(client -> logReport(service.reload()));
