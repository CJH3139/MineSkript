...
@Name("Is In (List)")
@Description({
        "Checks whether a value equals any entry of a list, such as online player names, a split text, or a list written in the script with commas, and, or. Entries are compared the same way as Is, so text ignores capitals: \"notch\" is in a list holding \"Notch\". An empty list never contains anything. The negated form is not in is also true when the list is empty.",
