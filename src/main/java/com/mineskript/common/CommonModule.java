...
import com.mineskript.common.elements.effects.EffReplace;
...
import com.mineskript.common.elements.expressions.ExprDamage;
...
import com.mineskript.common.elements.expressions.ExprJoinSplit;
...
import com.mineskript.common.elements.expressions.ExprArgument;
...
import com.mineskript.common.elements.expressions.ExprStringCase;
import com.mineskript.common.elements.expressions.ExprSubstring;
import com.mineskript.common.elements.expressions.ExprTimeState;
...
public final class CommonModule implements SyntaxModule {
    ...
    public void register(SyntaxRegistry registry) {
        ...
        ExprDamage.register(registry);
        ExprTimeState.register(registry);
        ...
        ExprStringCase.register(registry);
        ...
        ExprArgument.register(registry);
